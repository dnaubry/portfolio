...
function stickyNav() {
    var nav = (0, _jquery2.default)('.navbar'),
        ...
        headerTitleHeight = (0, _jquery2.default)('.site-header__titles').height(),
        headerLinks = (0, _jquery2.default)('.navbar a');

    (0, _jquery2.default)(window).scroll(addStickyClass);
    addSmoothScrolling();

    function addStickyClass() {
        if ((0, _jquery2.default)(this).scrollTop() > headerTitleHeight) {
